...
### Blake James Lester — Room 5 #171 move-out ([task 1213023485727524](https://app.asana.com/0/0/1213023485727524/f))
- ruled_by: asana-comment | ruled_on: 2026-07-06
- Eviction (non-payment of rent). Original OCR charge = Door $250 + Room cleaning $150 + Blinds/Curtains $120 = $520.
- RESOLVED final split — APPLIED $250 (Door, confirmed by Maintenance 2026-03-03, comment 1213533560082395). WAIVED $270 = Room cleaning $150 (OCR REVIEWED 2026-02-13 comment 1213263956746715 states "Can be waived based from tenant's previous reports about house cleanliness"; OCR review notes: "room clean", "No damaged items identified", tenant left room key) + Blinds/Curtains $120 (proof "not totally clear" per same OCR comment, never confirmed clear in any later comment).
- BOND: Ariadna ruling 2026-02-04 (comment 1213108152744341) — "let him go... deduct the remaining balance from the bond." Remaining balance (incl. unpaid rent + $250 door) applied against bond.
- NCAT: Threat only (last mention 2026-02-12, comment 1213241994673822 "Tenant's dispute - NCAT Threat"). No NCAT filing, hearing, or outcome in any subsequent comment through 2026-03-09. Treated as not-active / not-resolved-formally but no longer pending → needs_asana_check=no.
- MOVE-OUT DATE: Outgoing Condition Report dated 7 Feb 2026 (comment 1213263957260762); OCR/ICR conducted 7 Feb 2026 (comment 1212544947296842); move-out scheduled 2/7/2026; move-out confirmation sent 2026-02-03. Confirmed move-out date = 2026-02-07.
- Endorsed to Accounting via task 1213266970685788 (comment 1213203848791479).
...
- Ghulam Hassan #172 — real start 2025-05-19 ([1210154283246060](https://app.asana.com/0/0/1210154283246060/f))
- Muhammad Ahmed #479 — real start 2025-05-23 ([1210343112447001](https://app.asana.com/0/0/1210343112447001/f))
- Melany Gimenez #170 — real start 2025-06-05 ([1210379850425330](https://app.asana.com/0/0/1210379850425330/f))
- Ramiro/Santiago #168 — real start 2025-05-13 ([1210217728092601](https://app.asana.com/0/0/1210217728092601/f))
In-window missed events: none. Post-window move-outs: none. Lookalikes (2024 #173 Mischa Abbott, foreign-address hits) ignored.
