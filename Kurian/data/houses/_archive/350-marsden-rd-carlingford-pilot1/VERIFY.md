...
- [PASS] row-count: top-level 79 - 4 excluded + 1 promoted-subtasks vs timeline events 76 (delta 0)
...
- [INFO] per-room in/out balance: {'1169': 'in=4 out=1', '1170': 'in=3 out=2', '1171': 'in=2 out=2', '1173': 'in=2 out=3', '1174': 'in=2 out=1', '1175': 'in=5 out=3', 'UNRESOLVED': 'in=1 out=0'}
