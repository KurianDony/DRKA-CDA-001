...
- [PASS] row-count: top-level 65 - 3 excluded + 0 promoted-subtasks vs timeline events 62 (delta 0)
...
- [INFO] per-room in/out balance: {'168': 'in=1 out=1', '168A': 'in=2 out=2', '170': 'in=2 out=2', '171': 'in=2 out=2', '172': 'in=2 out=1', '174': 'in=4 out=3', '479': 'in=3 out=2', 'UNRESOLVED': 'in=0 out=0'}
