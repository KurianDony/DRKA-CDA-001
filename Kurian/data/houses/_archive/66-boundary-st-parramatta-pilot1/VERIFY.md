...
- [PASS] row-count: top-level 87 - 4 excluded + 0 promoted-subtasks vs timeline events 83 (delta 0)
...
- [INFO] per-room in/out balance: {'10': 'in=4 out=2', '11': 'in=3 out=3', '13': 'in=1 out=1', '7': 'in=2 out=3', '8': 'in=1 out=1', '9': 'in=1 out=1', 'UNRESOLVED': 'in=1 out=0'}
